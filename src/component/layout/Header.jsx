    ...
    return (
      <header {...props} className={classes}>
        <div className="container">
          <div className={
            classNames('site-header-inner', bottomDivider && 'has-bottom-divider')}>
            <Logo />
            {!hideNav &&
              <>
                  ...
                  <div className="header-nav-inner">
                    ...
                    {!hideSignin &&
                      <ul className="list-reset header-nav-right">
                        <li>
                          <Link to="#" className="button button-primary button-wide-mobile button-sm" onClick={closeMenu}>FAQ</Link>
                        </li>
                      </ul>}
                  </div>
                </nav>
